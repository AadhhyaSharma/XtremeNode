<template>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        >
          ...
          <p class="text-[11px] opacity-60">
            XtremeNode waits for this process. When it closes, the stream ends.
          </p>
        </section>
            ...
            <li v-for="(value, index) in form.detached" :key="index">
              ...
              >
                ...
                <div class="p-3 space-y-2">
                  ...
                  />
                  <p class="text-[11px] opacity-60">
                    Runs before the primary command. XtremeNode continues even if this command exits.
                  </p>
                </div>
              </div>
            </li>
    ...
    <div v-if="!isPlaynite" class="space-y-1 md:col-span-2">
      ...
      <p class="text-[11px] opacity-60">Optional; stored only and not fetched by XtremeNode.</p>
    </div>
  </div>
</template>
