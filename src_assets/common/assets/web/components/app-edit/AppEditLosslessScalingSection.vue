<template>
  <div class="mt-4 space-y-4 rounded-md border border-dark/10 p-3 dark:border-light/10">
    <div class="flex items-center justify-between gap-3">
      <div>
        ...
        <p class="text-[11px] opacity-60">
          Enable Lossless Scaling when you want XtremeNode to manage upscaling before encoding.
        </p>
      </div>
    ...
    <n-alert
      ...
      class="text-xs"
    >
      This application isn't managed by Playnite. XtremeNode will try to guess which game executable
    ...
    <div v-if="form.losslessScalingEnabled" class="space-y-4">
      <div class="grid gap-3 md:grid-cols-2">
        <div class="space-y-1">
          ...
          <p class="text-[11px] opacity-60">
            Recommended keeps XtremeNode-tuned values for consistent latency and frame pacing. Custom
