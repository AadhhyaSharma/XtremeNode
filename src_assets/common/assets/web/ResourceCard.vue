...
const resources = computed(() => [
  ...
  {
    href: 'https://github.com/Nonary/XtremeNode/discussions',
    icon: 'fab fa-github',
  ...
  {
    href: 'https://github.com/Nonary/XtremeNode/issues',
    icon: 'fab fa-github',
    title: 'GitHub Issues',
...
const legalLinks = computed(() => [
  {
    href: 'https://github.com/Nonary/XtremeNode/blob/master/LICENSE',
  ...
  {
    href: 'https://github.com/Nonary/XtremeNode/blob/master/NOTICE',
