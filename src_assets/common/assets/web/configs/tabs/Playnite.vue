              ...
              <div>
                ...
                <div class="form-text">
                  {{
                    ...
                    'Choose how XtremeNode removes old auto-synced games.'
                  }}
                </div>
              </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 items-start">
            <div class="md:col-span-2">
              <Checkbox
                ...
                desc="When enabled, XtremeNode adds a launcher entry that opens Playnite in fullscreen desktop mode."
              />
            </div>
            <div>
  ...
  if (syncAll) {
    parts.push(
      (t('playnite.summary_all_installed') as any) ||
        'All installed Playnite games will be kept in XtremeNode.',
    );
