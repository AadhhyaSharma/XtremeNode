            ...
            <div class="min-h-screen flex flex-col bg-light dark:bg-dark text-dark dark:text-light">
              ...
              >
                <div class="flex items-center gap-3 min-w-0">
                  <img src="/images/logo-apollo-45.png" alt="XtremeNode" class="h-8 w-8" />
                ...
                <nav class="hidden md:flex items-center gap-1 text-sm font-medium ml-2">
                  ...
                  <RouterLink to="/tunnel" :class="linkClass('/tunnel')">
                    <i class="fas fa-network-wired" /><span>Public Access</span>
                  </RouterLink>
...
const isEmbedRoute = computed(() => route.meta?.noHeader === true);
